...
import com.tw.dojo.bouncingBall.model.BouncingBallAlgo;
import com.tw.dojo.bouncingBall.model.ElasticBallAlgo;
...
public class BallTestHarness {
    ...
    public static int oneStepDownFrom(int centerY) {
        return centerY + BouncingBallAlgo.MOVEMENT_SPEED;
    }
    ...
    public static int oneStepInwardsFrom(int radius) {
        return radius - ElasticBallAlgo.GROWTH_RATE;
    }
